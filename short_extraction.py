...
# https://www.sl886.com/stock/list?list=shortsell&code=00700&page=1
...
defined_col = ['Date', 'Short_Ratio', 'Short_Count', 'Short_Amount']
#-----------------------------------------------------------------------------------
...
table = construct_table('https://www.sl886.com/stock/list?list=shortsell&code=' + ticker_text)

table.columns = defined_col

if os.path.exists(save_dir + '/' + ticker + '/' + 'Short' + '.csv'):
    old_table = pd.read_csv(save_dir + '/' + ticker + '/' + 'Short' + '.csv')
...
table.to_csv(save_dir + '/' + ticker + '/' + 'Short' + '.csv', index = None, encoding = 'utf-8-sig')
